...
import { syncRecentProjects, getCacheStats } from '~/lib/legal/project-cache-sync';
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.log(
      `[cache-sync] Listo — ${result.inserted} nuevos, ${result.updated} actualizados; catálogo total: ${stats.total}`,
    );
