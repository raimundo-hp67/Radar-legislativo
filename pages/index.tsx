  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-50 font-sans dark:bg-slate-950">
      <main className="flex w-full max-w-2xl flex-col items-center gap-8 px-8 py-32 text-center">
        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-cyan-500 shadow-lg shadow-cyan-500/25">
        ...
        <Link
          className="inline-flex h-12 items-center justify-center gap-2 rounded-full bg-cyan-600 px-6 text-base font-medium text-white shadow-sm transition-all hover:bg-cyan-500 hover:shadow-md"
          href="/legal"
        >
          Ir al dashboard
