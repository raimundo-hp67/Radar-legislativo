...
export function LobbyAgent() {
  ...
  return (
    <div className="flex h-[600px] flex-col rounded-2xl border border-slate-200/80 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
      {/* Messages area */}
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        <AiUnavailableNotice />
        {messages.length === 0 && (
          <div className="flex flex-col items-center justify-center h-full text-center">
            <div className="flex h-12 w-12 items-center justify-center rounded-full bg-cyan-100 dark:bg-cyan-900/30 mb-4">
        ...
        {messages.map((msg, i) => (
          ...
          >
            {msg.role === 'assistant' && (
              <div className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-cyan-100 dark:bg-cyan-900/30">
            ...
            {msg.role === 'user' && (
              <div className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-slate-200 dark:bg-slate-600">
        ...
        {isLoading && (
          <div className="flex gap-3">
            ...
            <div className="flex items-center gap-2 rounded-lg bg-slate-100 px-3.5 py-2.5 dark:bg-slate-800">
