...
// El CSV de InfoLobby no trae el ID ni el código de institución de la
// audiencia, así que no hay enlace directo al registro puntual. Llevamos al
// directorio oficial de instituciones para que el abogado busque desde ahí.
            ...
            ? (
                <div className="py-12 text-center text-sm text-slate-500">
                  {(analytics?.total ?? 0) === 0
                    ? (
                        <>
                          <p className="font-medium text-slate-700 dark:text-slate-300">Aún no hay audiencias en la base de datos.</p>
                          <p className="mt-1">
                            Pulsa el botón
                            {' '}
                            ...
                            {' '}
                            <code className="rounded bg-slate-100 px-1 dark:bg-slate-800">bun run scripts/sync-lobby.ts</code>
                            .
                          </p>
                        </>
                      )
                        ...
                        >
                          ...
                          <td className="px-3 py-2.5">
                            <div className="flex items-start gap-1.5">
                              <User className="h-3 w-3 mt-0.5 text-cyan-500 flex-shrink-0" />
                              <div>
